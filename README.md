...
Two parts of Express I learner are server-side routing and middleware

- [x] Describe Middleware?

Middleware are functions outside of the promise that execute prior to the promise and perform tasks that would otherwise have to be coded inside the promise in order for the promise to properly execute.

- [x] Describe a Resource?

A resource is the data a particular promise is attempting to retrieve.

- [x] What can the API return to help clients know if a request was successful?

The API can return a message as well as the requested data.

- [x] How can we partition our application into sub-applications?

We can partition an application through server-side routing.
